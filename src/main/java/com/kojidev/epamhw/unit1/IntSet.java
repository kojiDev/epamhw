...
/**
 * A very basic and pathetic implementation of a BitSet pattern
 * which provides you basic BitSet functionality such as:
 * adding/deleting integers from the set, check whether the set contains one etc.
 *
 * @author stan
 */
public class IntSet {
     ...
     *
     * @param data An array of integers to populate
     */
